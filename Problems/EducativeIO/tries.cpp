...
Tries are mostly used for searching words in the dictionary, provide auto-suggestions in search engines, and for IP routing as well.
*/
...
int main_TrieNode() {
  //TrieNode *t = t->getNode();
  TrieNode *t = new TrieNode();
  
  cout << "Children: " << t->children[0] << endl;
  cout << "isEndWord: " << t->isEndWord << endl; 
