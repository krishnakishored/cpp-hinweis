...
#ifndef BITSET_ARITHMETIC
#define BITSET_ARITHMETIC
#endif
...
//To perform basic arithmetic and comparison operations on a set of bits as if it were a binary representation of an unsigned integer number.
