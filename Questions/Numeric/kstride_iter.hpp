...
#endif
//stride iterators when the step size is known at compile time, called a kstride_iter. 
//Since the step size is passed as a template parameter, the compiler can much more effectively opti- mize the code for the iterator, and the size of the iterator is reduced.
